...
const Experiences = () => {
    ...
    const experiences = useMemo(() => [
        ...
        },
        {
            ...
            about: "Learn the secrets of authentic Mewari masalas and traditional dishes like Dal Baati Churma under the guidance of royal palace master chefs.",
        ...
        },
        {
            ...
            about: "Explore the dramatic amber-lit corridors of Amer Palace at night. A bespoke session with professional photographers specializing in heritage aesthetics.",
            location: "Jaipur, Rajasthan"
        },
        {
            id: 4,
        ...
        <main className="jali-overlay min-h-screen pb-20 bg-background text-left">
            ...
            <div className="max-w-6xl mx-auto px-6 md:px-16 lg:px-24 xl:px-32 pt-10">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 gap-4 border-b border-gray-200/50 pb-6">
                    <div>
                        <h1 className="font-montserrat text-3xl font-extrabold text-primary">Royal Experiences</h1>
                        <p className="text-gray-500 font-inter text-sm mt-1">Immerse yourself in the legendary lifestyle and heritage of India.</p>
                    </div>
                </div>
                        ...
                        >
                            ...
                            <div className="p-6 w-full sm:w-3/5 flex flex-col justify-between">
                                ...
                                <div className="flex justify-between items-center border-t border-gray-100 pt-4 mt-6">
                                    ...
                                    <button 
                                        onClick={() => toast.success(`Experience "${exp.title}" booked successfully! Expect butler coordination soon.`)}
